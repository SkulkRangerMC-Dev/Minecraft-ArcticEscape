package sculkrange.faraway.arctic.sound;
...
public class ModSounds {
    ...
    public static final SoundEvent HELIOS = registerSoundEvent("helios");
    ...
    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = new Identifier(FarawayArcticEscape.MOD_ID, name);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of(id));
    }

    public static void registerSounds() {
        FarawayArcticEscape.LOGGER.info("The sound of ancient music soothes the soul.");
    }
}